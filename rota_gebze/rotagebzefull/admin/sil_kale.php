...
if ($conn->query("DELETE FROM tarihi_kaleler WHERE id =".(int)$_GET['id'])) // id'si seçilen veriyi silme sorgumuzu yazıyoruz.
{
	header("location:tarihi_kaleler.php"); // Eğer sorgu çalışırsa ekle.php sayfasına gönderiyoruz.
}
}
