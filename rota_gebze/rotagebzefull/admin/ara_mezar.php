          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table class="table center-aligned-table">
                ...
                if ($_POST) 
                    $ara = $_POST["s"]; 
                    $sorgu = $conn->query("SELECT * FROM sehit_mezarligi where baslik like '%$ara%'"); // Makale tablosundaki tüm verileri çekiyoruz.
                    if (mysqli_num_rows($sorgu)<1) { echo "<script>window.location.replace('sehit_mezarligi.php')</script>";} 
                    else
