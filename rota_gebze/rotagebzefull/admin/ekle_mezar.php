...
<div class="content-wrapper">
  <h3 class="page-heading mb-4">Şehit Mezarlığı Ekleme</h3>
  <div class="row mb-2">
    <div class="col-lg-12">
      <div class="card">
        <div class="card-body">
            ...
            if (file_exists('images/' . $dosya_adi)) {
                ...
                if ($boyut > (1024 * 1024 * 2)) {
                    ...
                    if (!in_array($dosya_tipi, ['image/png', 'image/jpeg']) || !in_array($dosya_uzanti, ['png', 'jpg'])) {
                        ...
                        if ($conn->query("INSERT INTO sehit_mezarligi (foto, baslik, icerik) VALUES ('$dosya_adi','$baslik','$icerik')")) // Veri ekleme sorgumuzu yazıyoruz.
                        {
                            echo "Veri Eklendi";
                            echo "<script>window.location.replace('sehit_mezarligi.php')</script>"; // Eğer veri eklendiyse eklendi yazmasını sağlıyoruz.
                        } else {
                            echo "Hata oluştu";
                        }
                    }
