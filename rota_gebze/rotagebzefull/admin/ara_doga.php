...
<div class="content-wrapper">
  <h3 class="page-heading mb-4">Doga Turizmi</h3>
  <div class="row mb-2">
    <div class="col-lg-12">
      <div class="card">
        <div class="card-body">
          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table class="table center-aligned-table">
                ...
                if ($_POST) 
                    $ara = $_POST["s"]; 
                    $sorgu = $conn->query("SELECT * FROM doga_turizmi where baslik like '%$ara%'"); // Makale tablosundaki tüm verileri çekiyoruz.
                    if (mysqli_num_rows($sorgu)<1) { echo "<script>window.location.replace('doga_turizmi.php')</script>";} 
                    else
