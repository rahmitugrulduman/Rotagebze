...
$sorgu = $conn->query("SELECT * FROM kullanicilar"); // Makale tablosundaki tüm verileri çekiyoruz.
...
// While döngüsü ile verileri sıralayacağız. Burada PHP tagını kapatarak tırnaklarla uğraşmadan tekrarlatabiliriz. 
    ?>
            ...
            <td><span><a href="duzenle_kullanici.php?tc=<?php echo $tc; ?>" ><i class="fa-solid fa-pen-to-square ikon"></i></a></span>
