...
<div class="content-wrapper">
  <h3 class="page-heading mb-4">Doğa Turizmi</h3>
  <div class="row mb-2">
    <div class="col-lg-12">
      <div class="card">
        <div class="card-body">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                <form action="ara_doga.php" method="POST">
...
<div class="card-deck">
        <div class="card col-lg-12 px-0 mb-4">
          <div class="card-body">
            <a href="ekle_doga.php" ><i class="fa-solid fa-plus ekleme"></i></a>
...
$sorgu = $conn->query("SELECT * FROM doga_turizmi"); // Makale tablosundaki tüm verileri çekiyoruz.
...
// While döngüsü ile verileri sıralayacağız. Burada PHP tagını kapatarak tırnaklarla uğraşmadan tekrarlatabiliriz. 
    ?>
            ...
            <td><span><a href="duzenle_doga.php?id=<?php echo $id; ?>" ><i class="fa-solid fa-pen-to-square ikon"></i></a></span>
            <span><a href="sil_doga.php?id=<?php echo $id; ?>" ><i class="fa-solid fa-trash-can ikon" ></i></a></span></td>
        </tr>
